...
def _extract_pr_id(response) -> str | None:
    ...
    if not isinstance(data, dict):
        return None
    pr_id = data.get("id") or data.get("purchase_request_id")
...
def test_t_43_3(test_data, detail_log_path):
    ...
    if pr_id and not cleanup_ok:
        try:
            ...
            # Operator must do manual cleanup via Alma staff UI. The summary
            # records cleanup_ok=False; the request_id is in the detail log.
            pass
